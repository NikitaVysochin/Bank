...
function TestCard({ item, dateCard }) {
  ...
  return (
    <>
    <div className="container preload" onClick={Flipped}>
        <div className={bool ? 'creditcard' : 'creditcard flipped'}>
            <div className="front">
                <div id="ccsingle"></div>
                <svg version="1.1" id="cardfront"
                    ...
                    <g id="Front">
                        ...
                        <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" className="st2 st3 st4">{item.number}</text>
                        <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" className="st2 st5 st6">{item.name}</text>
            ...
            <div className="back">
                <svg version="1.1" id="cardback" 
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                        ...
                        <text transform="matrix(1 0 0 1 621.999 227.2734)" id="svgsecurity" className="st6 st7">{item.cvv}</text>
                        <g className="st8">
                        ...
                        <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" className="st12 st13">{item.name}</text>
                    </g>
                </svg>
            </div>
        </div>
